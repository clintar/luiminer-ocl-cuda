...
#define FFT8(xb, xs, d)   do { \
    ...
    int a3 = x0 - (x2 << 4); \
    int b0 = x1 + x3; \
    int b1 = REDS1((x1 << 2) + (x3 << 6)); \
    int b2 = (x1 << 4) - (x3 << 4); \
    int b3 = REDS1((x1 << 6) + (x3 << 2)); \
    d ## 0 = a0 + b0; \
    d ## 1 = a1 + b1; \
    d ## 2 = a2 + b2; \
    d ## 3 = a3 + b3; \
 ...
 * beta^(255*i) mod 257
 */
__constant__ unsigned short yoff_b_n[] = {
...
#define INNER(l, h, mm)   (((uint32)((l) * (mm)) & 0xFFFFU) \
	+ ((uint32)((h) * (mm)) << 16))
...
#define STEP_ELT(n, w, fun, s, ppb)   do { \
	uint32 tt = T32(D ## n + (w) + fun(A ## n, B ## n, C ## n)); \
	A ## n = T32(ROTL32(tt, s) + XCAT(tA, XCAT(ppb, n))); \
	D ## n = C ## n; \
	C ## n = B ## n; \
	B ## n = tA ## n; \
} while (0)
...
#define STEP_BIG(w0, w1, w2, w3, w4, w5, w6, w7, fun, r, s, pp8b)   do { \
	uint32 tA0 = ROTL32(A0, r); \
	uint32 tA1 = ROTL32(A1, r); \
	uint32 tA2 = ROTL32(A2, r); \
	uint32 tA3 = ROTL32(A3, r); \
	uint32 tA4 = ROTL32(A4, r); \
	uint32 tA5 = ROTL32(A5, r); \
	uint32 tA6 = ROTL32(A6, r); \
	uint32 tA7 = ROTL32(A7, r); \
...
__global__ void kernelSimd512(unsigned char *hashes) {
	...
	uint32 A0 = 0x0BA16B95, A1 = 0x72F999AD, A2 = 0x9FECC2AE, A3 = 0xBA3264FC, A4 = 0x5E894929, A5 = 0x8E9F30E5, A6 = 0x2F1DAA37, A7 = 0xF0F2C558;
	uint32 B0 = 0xAC506643, B1 = 0xA90635A5, B2 = 0xE25B878B, B3 = 0xAAB7878F, B4 = 0x88817F7A, B5 = 0x0A02892B, B6 = 0x559A7550, B7 = 0x598F657E;
	uint32 C0 = 0x7EEF60A1, C1 = 0x6B70E3E8, C2 = 0x9C1714D1, C3 = 0xB958E2A8, C4 = 0xAB02675E, C5 = 0xED1C014F, C6 = 0xCD8D65BB, C7 = 0xFDB7A257;
	uint32 D0 = 0x09254899, D1 = 0xD699C7BC, D2 = 0x9019B6DC, D3 = 0x2B9022E4, D4 = 0x8FA14956, D5 = 0x21BF9BD3, D6 = 0xB94D0943, D7 = 0x6FFDDC22;

	FFT256(0, 1, 0, ll1); /*ll1*/
	for (int i = 0; i < 256; i ++)
	{
		int tq;
	...
	uint32 dataHash[16];
	for (i = 0; i < 16; i++) 
		dataHash[i] = dec32le2(hashes + (tid*64) + (i << 2));
	...
	uint32 COPY_A0 = A0, COPY_A1 = A1, COPY_A2 = A2, COPY_A3 = A3, COPY_A4 = A4, COPY_A5 = A5, COPY_A6 = A6, COPY_A7 = A7;
	uint32 COPY_B0 = B0, COPY_B1 = B1, COPY_B2 = B2, COPY_B3 = B3, COPY_B4 = B4, COPY_B5 = B5, COPY_B6 = B6, COPY_B7 = B7;
	uint32 COPY_C0 = C0, COPY_C1 = C1, COPY_C2 = C2, COPY_C3 = C3, COPY_C4 = C4, COPY_C5 = C5, COPY_C6 = C6, COPY_C7 = C7;
	uint32 COPY_D0 = D0, COPY_D1 = D1, COPY_D2 = D2, COPY_D3 = D3, COPY_D4 = D4, COPY_D5 = D5, COPY_D6 = D6, COPY_D7 = D7;
...
#undef q
	...
	for (i = 0; i < 16; i++)
		enc32le2(hashes + (tid*64) + (i << 2), dataHash[i]);
